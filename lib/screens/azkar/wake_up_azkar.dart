...
class WakeUpAzkarPage extends StatefulWidget {
  const WakeUpAzkarPage({super.key});

  @override
  State<WakeUpAzkarPage> createState() => _WakeUpAzkarPageState();
}

class _WakeUpAzkarPageState extends State<WakeUpAzkarPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(appLocalizations.wakeUpAzkar),
        actions: [
      ...
      body: AnimatedList(
        ...
        initialItemCount: _getWakeUpAzkar(isArabic).length,
        itemBuilder: (context, index, animation) {
          final azkar = _getWakeUpAzkar(isArabic)[index];
              ...
              Row(
                ...
                children: [
                  ...
                  DhikrCounterButton(
                    ...
                    index: index,
                    dhikrTitle: azkar['title'] ?? 'Wake Up Dhikr',
                    onComplete: (count) {
  ...
  List<Map<String, String>> _getWakeUpAzkar(bool isArabic) {
    if (isArabic) {
      return [
        {
